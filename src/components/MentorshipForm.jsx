...
// ✅ FIXED AMOUNT (no env override)
const PAYFAST_AMOUNT = '350';
        ...
        <div className="modal" role="dialog" aria-modal="true">
          <div className="modal-panel">
            <div className="modal-head">
              ...
              <h3>Confirm & Pay</h3>
              <span className="pill">R{PAYFAST_AMOUNT}</span>
            </div>
            ...
            <div className="modal-body">
              ...
              <form id="payfastForm" action={PAYFAST_URL} method="post" className="hidden-form">
                ...
                <input type="hidden" name="amount" value={PAYFAST_AMOUNT} />
